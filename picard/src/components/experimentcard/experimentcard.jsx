...
const ExperimentCard = ({ experimentName, link, experimentState }) => {
  ...
  return (
    <div className="card flex justify-between items-center p-5 m-2 border-2 bg-[#001D3D] rounded-lg shadow-md max-w-xl w-full">
      <div className="card-content flex justify-between items-center w-full">
        ...
        <a href={link} target="_blank" rel="noopener noreferrer" className="text-white no-underline flex-1 text-center hover:underline">
          View Experiment
        </a>
